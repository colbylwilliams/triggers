...
| **Joker** | `.github/agents/joker.md` | `issues: opened` |
...
### Method 4: Create Test PR workflow

Use the **Create Test PR** workflow from the Actions tab to automatically create a branch and PR with a chosen failure type (`forbidden-comment`, `typescript-error`, or `both`).
