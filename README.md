...
| **Trigger Joker Daily** | `.github/workflows/trigger-joker-daily.yaml` | Runs daily on a cron schedule and opens an issue asking the `joker` agent for a joke |
...
| **Joker** | `.github/agents/joker.md` | Daily issue created by `Trigger Joker Daily` workflow |
