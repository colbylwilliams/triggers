...
| **Trigger Joker Daily** | `.github/workflows/trigger-joker-daily.yaml` | Runs daily on a schedule and opens an issue to trigger the joker agent |
...
| **Joker** | `.github/agents/joker.md` | Daily trigger issue opened by `Trigger Joker Daily` workflow |
