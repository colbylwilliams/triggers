...
| **Create Test PR** | `.github/workflows/create-test-pr.yaml` | Manually dispatched workflow that creates a test PR with a chosen failure type |
...
The **Check Code Comments** and **Build** workflows support `workflow_dispatch` — trigger them manually from the Actions tab. Use the **Create Test PR** workflow to automatically create a test branch and PR with a chosen failure type.
